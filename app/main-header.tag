<main-header>
    <header class="main-header">
      ...
      <a href="#" class="logo">
        ...
        <span class="logo-mini"><b>J</b>-ME</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Jaga</b>-Me</span>
      </a>
                  ...
                  <ul class="menu">
                    <li><!-- start message -->
                      <a href="#">
                        ...
                        <!-- The message -->
                        <p>Hello there! Thanks for joining Jaga-Me!</p>
                      </a>
                    </li>
                    <!-- end message -->
                  </ul>
                ...
                <li>
                  ...
                  <ul class="menu">
                    <li><!-- start notification -->
                      <a href="#">
                        <i class="fa fa-user-md text-aqua"></i> We have found a new matching!
                      </a>
                    </li>
                    <!-- end notification -->
                  </ul>
